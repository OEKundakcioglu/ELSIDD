...
from trans_mip_sec_part import heuristic_with_transportation_sec_part
...
res1=(heuristic_with_transportation_sec_part(split[1],key1,list(res["I"].values())[-1],list(res["I_prime"].values())[-1]))
